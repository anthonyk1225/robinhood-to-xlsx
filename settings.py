...
option_instruments = [
  ...
  { "name": 'strike_price', "width": 15, "formatting": { 'num_format': '$0.00' }, "cell_type": "number" },
...
selected_keys_orders = [
  { "name": 'fees', "width": 10, 'formatting': { 'num_format': '$0.00' }, "cell_type": "number" },
  ...
  { "name": 'price', "width": 10, 'formatting': { 'num_format': '$0.00' }, "cell_type": "number" },
  *instruments,
]
...
selected_keys_options = [
  ...
  { "name": "processed_premium", "width": 15, "formatting": { 'num_format': '$0.00' }, "cell_type": "number" },
  { "name": "premium", "width": 15, "formatting": { 'num_format': '$0.00' }, "cell_type": "number" },
...
selected_keys_events = [
  ...
  { "name": 'total_cash_amount', "width": 15, "formatting": { 'num_format': '$0.00' }, "cell_type": "number" },
  { "name": 'quantity', "width": 15, "formatting": {}, "cell_type": "number" },
  *option_instruments,
]
